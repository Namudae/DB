/*
    ...
    1. 숫자형
        ...
        a. number
            ...
            - 123456789012345678901234567890123456780000000000000
...
create table tblType (
    ...
    --num number(4,2) -- 소수이하 2자리 고정 확보 > 나머지 정수 부분 2자리
...
insert into tblType (num) values (333.14);
insert into tblType (num) values (333.1);
...
insert into tblType (txt1) values ("A"); --에러

--10 바이트 > 몇 글자? > 오라클 인코딩? > UTF-8 > 영어(1), 한글(3)
insert into tblType (txt1) values ('ABCDEFGHIJ');

--ORA-12899: value too large for column "HR"."TBLTYPE"."TXT1" (actual: 11, maximum: 10)
insert into tblType (txt1) values ('ABCDEFGHIJK'); --에러. 11바이트

insert into tblType (txt1) values ('가');
insert into tblType (txt1) values ('가나다');
insert into tblType (txt1) values ('가나다라'); --에러. 12바이트
